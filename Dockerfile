...
RUN yum -y install gd gd-devel wget httpd php gcc make perl tar supervisor rrdtool perl-Time-HiRes rrdtool-perl php-gd gcc-c++ git httpd-devel python-devel
